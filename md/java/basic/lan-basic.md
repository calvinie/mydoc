...
![img](/img/java/basic/java-string-pool.jpeg)
...
[String, StringBuffer, and StringBuilder](https://blog.csdn.net/Turniper/article/details/111112824)
...
3. HotSpot也是发展的，由于[一些问题](https://openjdk.org/jeps/122)的存在，HotSpot考虑逐渐去永久代，对于不同版本的JDK，实际的存储位置是有差异的，具体看如下表格：
...
```
[StackOverflow: Is Java “pass-by-reference” or “pass-by-value”?](Java is Pass-by-Value or Pass-by-Reference?)
...
相关文章：[Java 基础 - 反射机制详解](/md/java/basic/reflection.md)
...
![图片](/img/java/basic/exception.png)

相关文章：[Java 基础 - 异常机制详解](/md/java/basic/exception.md)
...
```
相关文章：[Java 基础 - 异常机制详解](/md/java/basic/generic.md)
## 注解
Java 注解是附加在代码中的一些元信息，用于一些工具在编译、运行时进行解析和使用，起到说明、配置的功能。注解不会也不能影响代码的实际逻辑，仅仅起到辅助性的作用。

相关文章：[Java 基础 - 注解机制详解](/md/java/basic/annotation.md)
